<?php
 ...
 @define('CONST_Replication_Url', 'http://download.geofabrik.de/russia/siberian-fed-district-updates');
 ...
 @define('CONST_Replication_Recheck_Interval', '30');   // How long to sleep if no update found yet
